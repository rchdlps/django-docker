# Generated by Django 2.0.8 on 2018-09-26 20:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=255, verbose_name='Nome de usuário')),
                ...
                ('number_home', models.CharField(blank=True, max_length=10, null=True, verbose_name='Número')),
                ...
                ('full_last_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='Sobrenome Completo')),
                ('phone', models.CharField(blank=True, max_length=50, null=True, verbose_name='Telefone')),
                ('cel_phone', models.CharField(blank=True, max_length=50, null=True, verbose_name='Celular')),
