...
LOCAL_APPS = [
    ...
    'project.posts.apps.PostsConfig',
    'project.blog.apps.BlogConfig',
    'project.profiles.apps.ProfilesConfig'
...
# https://django-allauth.readthedocs.io/en/admin/logout/latest/configuration.html
